...
Требуемые функции с указанными аргументами и выходным результатом.
Написаны авто-тесты, которые обеспечивают 100% покрытие реализованных функции по строкам.
